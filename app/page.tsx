...
export default function Home() {
  ...
  return <main>
    ...
    <div className="shell">
      ...
      <section className="content" id="inbox">
        <div className="synthetic-banner" role="note"><strong>DEMO SINTETIC</strong><span>Toate datele sunt inventate și nu reprezintă persoane, locații sau evidențe reale.</span></div>
        <div className="page-heading"><div><div className="eyebrow">VINERI, 14 FEBRUARIE 2025</div><h2>Inbox de siguranță</h2><p>Ține echipa pregătită, un pas la fiecare activitate.</p></div><button className="outline-button" type="button">＋ Activitate nouă</button></div>
